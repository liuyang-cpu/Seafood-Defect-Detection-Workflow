...
class YOLOEPEFreeTrainer(YOLOEPETrainer, YOLOETrainerFromScratch):
    ...
    This trainer combines linear probing capabilities with from-scratch training for prompts-free
...
class YOLOEVPTrainer(YOLOETrainerFromScratch):
    ...
    This trainer extends YOLOETrainerFromScratch to support visual prompts-based training,
