...
class YOLOEVPDetectPredictor(DetectionPredictor):
    ...
    This mixin provides common functionality for YOLO models that use visual prompting, including model setup, prompts
    ...
    Methods:
        ...
        get_vpe: Process source to get visual prompts embeddings.
    """
    ...
    def _process_single_image(self, dst_shape, src_shape, category, bboxes=None, masks=None):
        ...
        # Generate visuals using the visual prompts loader
    ...
    def get_vpe(self, source):
        """Process the source to get the visual prompts embeddings (VPE).
        ...
        Returns:
            (torch.Tensor): The visual prompts embeddings (VPE) from the model.
        """
