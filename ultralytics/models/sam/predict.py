...
class Predictor(BasePredictor):
    ...
    def prompt_inference(self, im, bboxes=None, points=None, labels=None, masks=None, multimask_output=False):
        ...
        Args:
            ...
            labels (np.ndarray | List | None): Point prompts labels with shape (N) or (N, num_points). 1 for foreground, 0 for background.
...
class SAM2Predictor(Predictor):
    ...
    def prompt_inference(
        ...
        Args:
            ...
            labels (np.ndarray | List[int] | None): Point prompts labels with shape (N,). 1 = foreground, 0 = background.
...
class SAM2VideoPredictor(SAM2Predictor):
    ...
    def inference(self, im, bboxes=None, points=None, labels=None, masks=None):
        ...
        method leverages SAM's (Segment Anything Model) architecture consisting of image encoder, prompts encoder, and
