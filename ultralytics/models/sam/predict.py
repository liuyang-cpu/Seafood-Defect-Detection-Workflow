...
class Predictor(BasePredictor):
    ...
    Methods:
        ...
        prompt_inference: Internal function for prompts-based segmentation inference.
    ...
    def inference(self, im, bboxes=None, points=None, labels=None, masks=None, multimask_output=False, *args, **kwargs):
        ...
        This method leverages SAM's (Segment Anything Model) architecture consisting of image encoder, prompts
    ...
    def prompt_inference(self, im, bboxes=None, points=None, labels=None, masks=None, multimask_output=False):
        ...
        This internal function leverages the Segment Anything Model (SAM) for prompts-based, real-time segmentation.
        ...
        Args:
            ...
            points (np.ndarray | List | None): Points indicating object locations with shape (N, 2) or (N, num_points,
                2), in pixels.
            labels (np.ndarray | List | None): Point prompts labels with shape (N) or (N, num_points). 1 for foreground,
                0 for background.
...
class SAM2Predictor(Predictor):
    ...
    It provides methods for model initialization, feature extraction, and prompts-based inference.
    ...
    def prompt_inference(
        ...
        Args:
            ...
            labels (np.ndarray | List[int] | None): Point prompts labels with shape (N,). 1 = foreground, 0 =
                background.
    ...
    def _prepare_prompts(self, dst_shape, bboxes=None, points=None, labels=None, masks=None):
        ...
        Args:
            ...
            points (np.ndarray | List | None): Points indicating object locations with shape (N, 2) or (N, num_points,
                2), in pixels.
            labels (np.ndarray | List | None): Point prompts labels with shape (N,) or (N, num_points). 1 for
...
class SAM2VideoPredictor(SAM2Predictor):
    ...
    def inference(self, im, bboxes=None, points=None, labels=None, masks=None):
        ...
        method leverages SAM's (Segment Anything Model) architecture consisting of image encoder, prompts
        encoder, and mask decoder for real-time and promptable segmentation tasks.
    ...
    def add_new_prompts(
        ...
        Notes:
            - Only one type of prompts (either points or masks) can be added per call.
    ...
    def get_im_features(self, im, batch=1):
        ...
        """
        backbone_out = self.model.forward_image(im)
        if batch > 1:  # expand features if there's more than one prompts
