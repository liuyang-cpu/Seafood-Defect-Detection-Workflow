...
class SAMModel(nn.Module):
    ...
    This class combines image encoders, prompts encoders, and mask decoders to predict object masks from images and
    input prompts.
    ...
    Attributes:
        ...
        mask_decoder (MaskDecoder): Predicts object masks from image and prompts embeddings.
...
class SAM2Model(torch.nn.Module):
    ...
    Attributes:
        ...
        sam_prompt_embed_dim (int): Dimension of SAM prompts embeddings.
        ...
        use_mask_input_as_output_without_sam (bool): Whether to directly output the input mask without using SAM prompts
    ...
    def __init__(
        ...
        Args:
            ...
            use_mask_input_as_output_without_sam (bool): Whether to directly output the input mask without using SAM
                prompts encoder and mask decoder on frames with mask input.
            max_cond_frames_in_attn (int): Maximum number of conditioning frames to participate in memory attention.
            directly_add_no_mem_embed (bool): Whether to directly add no-memory embedding to image feature on the first
                frame.
            use_high_res_features_in_sam (bool): Whether to use high-resolution feature maps in the SAM mask decoder.
        ...
        if use_obj_ptrs_in_encoder:
            # A conv layer to downsample the mask prompts to stride 4 (the same stride as
        ...
        # using a SAM prompts encoder + mask decoder
        ...
        # Part 4: SAM-style prompts encoder (for both mask and point inputs)
    ...
    def forward(self, *args, **kwargs):
        """Process image and prompts inputs to generate object masks and scores in video sequences."""
    ...
    def _build_sam_heads(self):
        """Build SAM-style prompts encoder and mask decoder for image segmentation tasks."""
    ...
    def _forward_sam_heads(
        ...
        """Forward pass through SAM prompts encoders and mask heads.
        ...
        if mask_inputs is not None:
            ...
            # and feed it as a dense mask prompts into the SAM mask encoder
            ...
            # Otherwise, simply feed None (and SAM's prompts encoder will add
    ...
    def _track_step(
        ...
        if mask_inputs is not None and self.use_mask_input_as_output_without_sam:
            ...
            # (see it as a GT mask) without using a SAM prompts encoder + mask decoder.
