...
class MaskDecoder(nn.Module):
    ...
    This class predicts masks given image and prompts embeddings, utilizing a transformer to process the inputs and
    ...
    Methods:
        forward: Predict masks given image and prompts embeddings.
    ...
    def forward(
        ...
        """Predict masks given image and prompts embeddings.
    ...
    def predict_masks(
        ...
        """Predict masks and quality scores using image and prompts embeddings via transformer architecture."""
...
class SAM2MaskDecoder(nn.Module):
    """Transformer-based decoder for predicting instance segmentation masks from image and prompts embeddings.
    ...
    Methods:
        forward: Predict masks given image and prompts embeddings.
        predict_masks: Predict instance segmentation masks from image and prompts embeddings.
    ...
    def predict_masks(
        ...
        """Predict instance segmentation masks from image and prompts embeddings using a transformer."""
        # Concatenate output tokens
        s = 0
        if self.pred_obj_scores:
