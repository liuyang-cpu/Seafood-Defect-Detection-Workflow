...
class FastSAMPredictor(SegmentationPredictor):
    ...
    Attributes:
        prompts (dict): Dictionary containing prompts information for segmentation (bboxes, points, labels, texts).
    ...
    Methods:
        ...
        prompts: Perform image segmentation inference based on various prompts types.
    ...
    def _clip_inference(self, images, texts):
        ...
        Args:
            ...
            texts (List[str]): List of prompts texts, each should be a string object.
