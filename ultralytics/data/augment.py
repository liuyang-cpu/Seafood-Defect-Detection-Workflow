...
class RandomLoadText:
    ...
    def __init__(
        ...
        Args:
            prompt_format (str): Format string for the prompts. The format string should contain a single pair of curly
        ...
        Attributes:
            prompt_format (str): The format string for the prompts.
    ...
    def __call__(self, labels: dict[str, Any]) -> dict[str, Any]:
        ...
        # Randomly select one prompts when there's more than one prompts
        texts = []
