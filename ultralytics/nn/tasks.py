...
class YOLOEModel(DetectionModel):
    ...
    supporting both prompts-based and prompts-free inference modes.
    ...
    Methods:
        ...
        set_vocab: Set vocabulary for prompts-free model.
    ...
    def set_vocab(self, vocab, names):
        """
        Set vocabulary for the prompts-free model.
        ...
        # re-parameterization for prompts-free model
    ...
    def get_vocab(self, names):
        ...
        device = next(self.model.parameters()).device
        head.fuse(self.pe.to(device))  # fuse prompts embeddings to classify head
    ...
    def set_classes(self, names, embeddings):
        ...
        assert not hasattr(self.model[-1], "lrpc"), (
            "Prompt-free model does not support setting classes. Please try with Text/Visual prompts models."
        )
