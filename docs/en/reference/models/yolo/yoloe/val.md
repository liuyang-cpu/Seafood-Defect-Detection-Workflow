---
description: Documentation for YOLOE validator classes in Ultralytics, supporting both text and visual prompts embeddings for object detection and segmentation models.
