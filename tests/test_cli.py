...
def test_fastsam(
    ...
    for s in (source, Image.open(source)):
        ...
        # Run inference with bboxes and points and texts prompts at the same time
...
def test_mobilesam() -> None:
    ...
    # Predict a segment based on a 1D point prompts and 1D labels.
    ...
    # Predict a segment based on a box prompts
